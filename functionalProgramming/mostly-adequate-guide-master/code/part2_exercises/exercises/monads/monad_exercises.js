...
var ex1 = _.compose(join, map(safeProp('name')), join, map(safeProp('street')), safeProp('address'));
...
var getResult = either(_.identity, unsafePerformIO); // use either for execute IO
console.log(getResult(ex4('sleepy@grandpa.net')));
console.log(getResult(ex4('sleep')));
