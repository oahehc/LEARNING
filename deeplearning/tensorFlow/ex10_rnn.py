...
# tf Graph input
x = tf.placeholder(tf.float32, [None, n_steps, n_inputs])  # 28*28 = img shape
# 10 = number of class
...
# weights.in * x + biases.in = 28*128
# weights.out * ?? + biases.out = 10*128 = class * batch_size ??
...
def RNN(X, weights, biases):
    ...
    # Make sure the time_major is changed accordingly. time_major: time is in major(first) dimension
