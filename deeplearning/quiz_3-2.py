...
hidden_layer_weights = [[0.1, 0.2, 0.4], [
    0.4, 0.6, 0.6], [0.5, 0.9, 0.1], [0.8, 0.2, 0.8]]
...
biases = [tf.Variable(tf.zeros(3)), tf.Variable(
    tf.zeros(2))]  # set biase = zero
...
# input 3*4  -> hidden_layer 4*3 -> 3*3 -> layer 3*2 -> output 3*2
# TODO: Create Model
